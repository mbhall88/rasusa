...
fn is_valid_genome_size(arg: String) -> Result<(), String> {
    ...
    App::new("rasusa")
        ...
        .arg(
            Arg::with_name("genome_size")
                ...
                .required(true)
                .takes_value(true)
                .validator(is_valid_genome_size),
        )
        .arg(
            Arg::with_name("v")
                .short("v")
...
mod tests {
    ...
    fn empty_string_is_invalid_genome_size() {
        ...
        assert!(is_valid_genome_size(arg).is_err())
    }
    ...
    fn int_only_is_valid() {
        ...
        assert!(is_valid_genome_size(arg).is_ok())
    }
